 ...
 * module in {@link net.tbnr.mc.commerce.GearzCommerce}
 *
...
public interface CommerceItemAPI {
    /**
     *
     * Stores a purchase of a {@link CommerceItem} subtype for a {@link net.cogzmc.engine.gearz.player.GearzPlayer}.
     *
     ...
     *
     * @param player The {@link net.cogzmc.engine.gearz.player.GearzPlayer} who has made this purchase.
     * @param clazz The {@link CommerceItem} class that relates to this purchase.
     */
    public void givePlayerItem(TBNRPlayer player, Class<? extends CommerceItem> clazz);

    /**
     *
     * Checks if a {@link net.cogzmc.engine.gearz.player.GearzPlayer} has purchased an item in the past.
     *
     * @param player The {@link net.cogzmc.engine.gearz.player.GearzPlayer} who we are checking.
     * @param clazz The {@link CommerceItem} class that relates to this search.
     *
     ...
     *
     * @param key The key to search for (based on {@link CommerceItemMeta}'s key variable).
     *
    ...
    /**
     *
     * Will return the instance of the CommerceItemMeta annotation that is related to the {@link CommerceItem} class passed.
     *
     * @param clazz The {@link CommerceItem} class that you are getting the meta for.
     *
     * @return The {@link CommerceItem}'s {@link CommerceItemMeta}.
     */
     ...
     *  creating instances of {@link CommerceItem}s for each purchase. This will also register
     *  events for each of those items.
     *
     * @param player The {@link net.cogzmc.engine.gearz.player.GearzPlayer} to reload purchases for.
     */

...
import net.cogzmc.engine.gearz.game.GameCountdown;
import net.cogzmc.engine.gearz.game.GameCountdownHandler;
...
import net.tbnr.mc.manager.TBNRMinigame;
...
//	    }
     ...
     *
     * @return Returns the {@link net.tbnr.mc.manager.TBNRPlayer} with the most skulls
     */
     ...
     *
     * @return Returns the {@link net.tbnr.mc.manager.TBNRPlayer} with the most points
     */
